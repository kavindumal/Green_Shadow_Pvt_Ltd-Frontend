...
const baseUrl = "http://localhost:8080/greenShadowPvtLtd/api/v1/log";

export function checkTokenValidity() {
  return $.ajax({
    url: "http://localhost:8080/greenShadowPvtLtd/api/v1/auth/validate-token",
    method: "POST",
    headers: {
...
export function getAllFields() {
  return $.ajax({
    url: "http://localhost:8080/greenShadowPvtLtd/api/v1/field",
    method: "GET",
    contentType: "application/json",
    headers: {
      Authorization: "Bearer " + token,
...
export function getAllCrops() {
  return $.ajax({
    url: "http://localhost:8080/greenShadowPvtLtd/api/v1/crop",
    method: "GET",
    contentType: "application/json",
    headers: {
      Authorization: "Bearer " + token,
